          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <form class="d-flex" role="search" style={{margin:"0px 150px 0px 0px"}}>
              <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                  <Link class="btn  btn-danger" aria-current="page" to="/Media/viewNewsByMedia">
                    View My News
                  </Link>
                </li>
                ...
                <li class="nav-item">
                  <Link class="btn  btn-danger" aria-current="page"to="/Media/ManageJournalists" >
                    Manage Journalists
                  </Link>
                </li>
                <li class="nav-item">
                  <Link class="btn  btn-danger" aria-current="page"to="/Media/Notification" >
